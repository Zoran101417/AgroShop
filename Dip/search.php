  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="produkti.php">Продукти</a></li>
        <li><a href="#" data-toggle="modal" data-target="#myModal">Контакт</a>
        </li>
      </ul>
      <form class="navbar-form navbar-right">
      <div class="form-group">
        <input type="text" class="form-control" name="user_query" placeholder="Пребарај">
      </div>
      <button type="submit" name="search" class="btn btn-default">Пребарај</button>
    </form>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <a href="#menu-toggle" id="menu-toggle"><span class="glyphicon glyphicon-chevron-left"> Производи</span></a>
...
<div id="products_box">
    ...
    $get_pro = "select * from products where products_keywords like '%$search_query%' ";
        ...
        <div class='wrapper row'>
          <div class='preview col-md-6'>
            ...
            <div class='preview-pic tab-content'>
              <div class='tab-pane active' id='pic-1'><img src='$pro_image' /></div>
