...
<nav class="navbar navbar-inverse navbar-fixed-top ">
  <div class="container-fluid">
    ...
    ?></a></li>
        <li><a href="login.php"><span class="glyphicon glyphicon-log-in"></span> Логирај се</a></li>
...
<header class="image-height">
        <img class="img-responsive" src="images/vegban.jpg">
</header>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <a href="#menu-toggle" id="menu-toggle"><span class="glyphicon glyphicon-chevron-left">Продукти</span></a>
                        <h1>AgroShop</h1>
                        <p>Ви ги претставува своите достапни производи од областа на зеленчукот, застапени скоро сите производи од зеленчуци и достапни во големи количини.</p>
