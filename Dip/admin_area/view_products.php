...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <tr align="center">
        ...
        <td style="padding-top: 35px;"><?php echo $pro_title; ?></td>
        <td><img src="<?php echo $pro_image; ?>" width="80" height="80" /></td>
        <td style="padding-top: 35px;"><?php echo $pro_price; ?></td>
        <td style="padding-top: 35px;"><a href="edit_product.php?edit_product=<?php echo $pro_id; ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
        <td style="padding-top: 35px;"><a href="delete_product.php?delete_product=<?php echo $pro_id; ?>"><i class="glyphicon glyphicon-remove"></i></a></td>
    </tr>
    <?php 
    }
     ?>
